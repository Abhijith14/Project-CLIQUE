       ...
       <!-- sidebar panel start -->
        ...
        <div class="page-center page-lg" style="margin-left: 100px;">
            ...
            <div class="container-fluid section-t-space px-0 layout-threecolumn">
                ...
                <div class="event-img bg-size blur-up lazyloaded " style="background-image: url(&quot;assets/images/cover/7.jpg&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
                    <img src="assets/images/cover/7.jpg" class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
