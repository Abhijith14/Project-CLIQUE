...
if(isset($_GET['cat']))
{
    $cat = $_GET['cat'];
    if ($cat == 1){
        $gallerypicname = "ENG.png";
        $sql = "SELECT * FROM categories WHERE language = 'English'";
    }
    elseif($cat == 2){
        $gallerypicname = "TAM.png";
        $sql = "SELECT * FROM categories WHERE language = 'Tamil'";
    }
    elseif($cat == 3){
        $gallerypicname = "MAL.png";
        $sql = "SELECT * FROM categories WHERE language = 'Malayalam'";
    }
    elseif($cat == 4){
        $gallerypicname = "TEL.png";
        $sql = "SELECT * FROM categories WHERE language = 'Telugu'";
    }
    elseif($cat == 5){
        $gallerypicname = "HIN.png";
        $sql = "SELECT * FROM categories WHERE language = 'Hindi'";
    }
   ...
   <!-- header start -->
            ...
            <div class="header-section">
                <div class="header-left">
                    ...
                    <div class="search-box">
                        ...
                        <input type="text" class="form-control search-type" placeholder="Search..." id="search_field">
    ...
    <div class="page-body container-fluid custom-padding newsfeed-style7">
        ...
        <div class="page-center page-lg" style="margin-left: 100px;">
            <div class="event-cover bg-none">
                <div class="event-img bg-size blur-up lazyloaded" style="background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
                    <img src="assets/images/categories/<?php echo $gallerypicname; ?>" class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
            ...
            <div class="gallery-section section-t-space">
                            <div class="gallery-top">
                                <div class="card-title">
                                    <h3>gallery</h3>
                                    <h5><?php echo $img_result->num_rows; ?> photos</h5>
                                </div>
                            </div>
                            <div class="portfolio-section ratio_square">
                                <div class="container-fluid p-0" id="original_div">
                                    <div class="row" id="original_div1">
                                        ...
                                        <div class="col-4">
                                            <div class="overlay">
                                                <div class="portfolio-image">
                                                        ...
                                                        <img src="assets/images/<?php echo $row['filepath']; ?>" alt="" class="img-fluid blur-up lazyload">
    ...
    <script>
        ...
        $("#search_field").keyup(function(){
              $.ajax({
                url: "getimages.php",
                type: "post",
                data: {"stringC" : document.getElementById("search_field").value,
                        "lang": <?php echo $cat; ?> },
                success: function(d) {
                    files = JSON.parse(d);
                    $('#original_div1').hide();
                    $('#original_div').empty();
                    var divCont = '<div class="row">';
                    for (let i = 0; i < files.length; i++) {
                            divCont = divCont + '<div class="col-4"><div class="overlay"><div class="portfolio-image"><img src="assets/images/' + files[i] + '" alt="" class="img-fluid blur-up lazyload">  </div> </div> </div>';
                    }
                    divCont = divCont + "</div>";

                    $('#original_div').append(divCont);
